...
Before turning in, we stepped out for a short wander. We picked up Zumzin peach wine — a Bhutanese staple worth trying — and stopped at Zangtopelri Lhakhang, a small temple tucked into a courtyard nearby. Unhurried, modest, already a different world. A TashiCell outlet nearby sorted local SIMs; data in Bhutan is expensive, so a local connection is worth getting early.
...
The drive is beautiful but demanding. The winding high-altitude roads are not kind to sensitive stomachs — we made several stops for fresh air and steadier ground. A tea break at Khandu Hotel in Phobjikha — lemon, ginger, honey, served with unhurried calm — helped considerably. The last hour of road, however, is less a drive and more an endurance test through what felt like loosely organised rubble. Worth it, but brace yourself.<br/><br/>
